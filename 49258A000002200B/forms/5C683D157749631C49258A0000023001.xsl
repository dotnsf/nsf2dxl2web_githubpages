...
</head><body bgcolor="aqua"><richtext>
...
<p class="pardef-4"><run><font color="gray"></font></run><xsl:value-of select="document/item[@name='Shared_Created']" /><run><font color="gray"></font></run></p>
<p class="pardef-2"/>
